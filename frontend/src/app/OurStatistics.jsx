...
export default function OurStatistics() {
  return (
    <div className="bg-primary rounded-2xl px-15 py-7">
      <h1 className="text-4xl text-center  font-bold text-accent ">
        Our Statistics
      </h1>
